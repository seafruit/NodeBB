	...
	*/
	...
	var constants = Object.freeze({
			...
			oauth2: {
				...
				clientID: '890501e8c86f3cff712d',
				clientSecret: '0173a456cdf95154e901a94bf95d101becd6c158',
				state: 'xyz'  //had to append this var to the object or the oauth server explodes
				},
			userRoute: 'https://api.github.com/user'
	...
	OAuth.getStrategy = function(strategies, callback) {
		if (configOk) {
			// console.log(OAuth,'----------------OAuth 是总函数，在library里');
			...
			if (constants.type === 'oauth') {
				...
				opts.callbackURL = nconf.get('url') + '/auth/' + constants.name + '/callback';
				console.log(opts.callbackURL,'---------ooooooooo');
				console.log(passportOAuth);
