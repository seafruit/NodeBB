...
module.exports = function(Topics) {
	...
	Topics.addPostData = function(postData, uid, callback) {
		//console.log('+++++++++++++++给 post 加上了 index 属性，主贴的 index=0 ++++++++++++++++++++++');
		...
		//console.log('llllllllllllllllll---llllllllll-pids是数字数组');
		//console.log(pids);
		...
		async.parallel({
			...
			//console.log('++++++results在这里是什么啊？　　　　ｕｓｅｒ信息+++++++++++++++++++++++');
			//console.log(results);
			if (err) {
				return callback(err);
			}
			...
			//console.log('++++++postdata  将ｕｓｅｒ信息嵌套在ｐｏｓｔｓ里面++++++++++++++++++++++++++++++');
			//console.log(postData);
